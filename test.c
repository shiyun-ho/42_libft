...
void	test_ft_isalpha(void)
{
	...
	{
		printf("%c", test_char);
		result = (int)ft_isalpha(test_char);
		printf("%i", result);
	}
	printf("\n");
	...
	{
		printf("%c", test_char2);
		std_result = (int)isalpha(test_char2);
		printf("%i", std_result);
	}
	printf("\n\n");
...
void	test_strncmp(void)
{
	...
	printf("ft_strncmp: %d, strncmp: %d, Test Passed: %s\n", result_ft,
		result_std, result_ft == result_std ? "YES" : "NO");
...
void	test_ft_toupper(void)
{
	...
	int non_char_value = 123;
		// This might cause undefined behavior with custom implementation
...
void	test_ft_strnstr(void)
{
	...
	maxlen = 11;
	result_ft = ft_strnstr(big, little, maxlen);
	expected_result = big + strlen(big) - strlen(little);
		// Point to the first character of the match
	printf("ft_strnstr: %p (expected: %p)\n", result_ft, expected_result);
	printf("Test Passed: %s\n", result_ft == expected_result ? "YES" : "NO");
